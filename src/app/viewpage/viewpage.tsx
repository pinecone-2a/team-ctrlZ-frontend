...
<Button>Edit page</Button></Link> </div> 
<div className="bg-[#E4E4E7] h-[1px] w-full mt-7"> </div>
<h1 className="font-semibold text-[16px] mt-4">About jake</h1>
<p className="mt-4">I’m a typical person who enjoys exploring different things. I also make music art as a hobby. Follow me along.</p>
</Card>
<Card className="w-[623px] h-[116px] p-6">
    <CardTitle>Social media URL</CardTitle>
    <p className="mt-5"> https://buymeacoffee.com/spacerulz44</p>
</Card>
...
<Heart/>
<p className="font-semibold text-[16px] mt-3">Be the first one to support Jake</p>
    </Card>
</Card>
</div>
...
<Card className="w-[628px] h-[509px] p-6">
      ...
      <div className="mt-4">
        <label className="font-medium text-[14px]">Enter BuyMeCoffee or social account URL:</label>
        <Input
      ...
      <Button className="mt-4 w-full" disabled={!url.trim()}>Support</Button>
    </Card>
</div>
</div>
   </div>
