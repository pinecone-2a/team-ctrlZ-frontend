...
export default function Sign({ formData, errors, handleChange, handleNext }) {
  return (
            ...
            <div className="flex flex-col gap-2">
              ...
              <Input
                ...
                className={`w-full mt-1 px-3 py-2 border ${
                  ...
                  formData.username ? "text-black" : "text-gray-500"
                } rounded-md`}
                placeholder="Enter username"
              />
            </div>
            <div>
              <button className="border bg-[#E4E4E7] w-[350px] py-2 rounded-md text-[#FAFAFA]">
                Continue
              </button>
            </div>
          </div>
